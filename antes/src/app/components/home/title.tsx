...
export const Title: FC<TitleProps> = ({ title }) => {
  ...
  return (
    <div className='flex flex-col justify-center items-center gap-12 w-full min-h-[500px] text-base font-font2 text-font1 bg-title-background bg-no-repeat bg-cover bg-center'>
