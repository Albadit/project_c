...
export default function Home() {
  ...
  return (
    <div className="">
      ...
      {/* Title */}
      <div className="text-center py-4 text-5xl font-bold text-primary">
        Agenda
      </div>
      ...
      {/* Calendar Box */}
      <div className="grid gap-1 shadow-md mx-6 mb-6 p-4 rounded-md">
  ...
  function getUpdatedDayNumber(index, startDayOfWeek) {
    const dayNumber = currentDate.getDate() + index - startDayOfWeek - 2;
    return dayNumber > 0 ? dayNumber : "";
  }

  function generateEventCard(day, startTime, endTime, eventName) {
